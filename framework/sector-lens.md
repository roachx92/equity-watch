...
|---|---|---|
| `ai-dc-lessor` | AI/HPC datacenter lessors, colocation and neoclouds | Hyperscaler capex guides · peer lease/colo deals **and their terms** (the multiple comp, not just the headline) · neocloud funding & credit conditions (CoreWeave, Fluidstack, Nscale, Lambda) · power & interconnect policy (e.g. ERCOT ILLE) · **HBM/DRAM supply from the accelerator memory chain — SK Hynix, Micron, Samsung** (channel: demand). HBM availability gates GPU/accelerator shipment volume, which gates when tenants can actually take and pay for contracted capacity — a direct input to rent-commencement and utilization tripwires. **NAND-focused names (SanDisk, Kioxia) are a materially weaker read-through** — they carry no accelerator-memory supply link and transmit almost entirely as regime beta; tag their moves `channel: regime`, never `demand`, unless a specific item ties back to HBM/DRAM capacity |
| `adv-packaging` | AI-accelerator substrates, advanced packaging, and the **OSAT tier** that assembles them | NVIDIA substrate allocation · ABF substrate capacity adds · glass-core / TGV roadmap events · TSMC CoWoS capacity · **OSAT capacity & utilization** — capex guides, utilization rates, 2.5D / high-density fan-out (HDFO) capacity adds, and **facility migrations that strand capacity mid-transfer**, across **Amkor (AMKR), ASE Technology (ASX), JCET, Powertech (PTI), KYEC, SPIL, TongFu** · **the advanced-vs-conventional split inside OSAT prints** — the cleanest available read on whether AI packaging demand is diverging from the commodity tier, and it is often buried in guidance rather than headlined (Amkor's Q2 2026: computing guided **+~30% QoQ** on AI datacenter and HDFO ramps while communications was guided **down high-single-digits** sequentially against normal H2 seasonality, on a Korea→Vietnam SiP migration stranding capacity into H1 2027) · **memory-complex selloffs as a demonstrated regime-beta driver (channel: regime, not demand/supply/peer-comp)** — Kioxia, SK Hynix, Micron and Samsung earnings/capacity/pricing news has repeatedly moved substrate names on pure AI-complex sympathy with zero company event (IBIDY fell ~11% on 2026-07-28 when Kioxia hit limit-down on NAND-oversupply fear, having no memory-supply relationship of its own); log it, but never conflate it with the slug's actual demand/supply/peer-comp fundamentals |
| `btc-mining` | Bitcoin price regime and miner economics | BTC price and ETF flows · hashprice · miner-to-HPC pivot announcements |
| `btc-treasury` | Corporate Bitcoin-treasury companies (leveraged BTC-per-share vehicles) and the mNAV-premium regime. **Distinct from `btc-mining`:** a treasury company has no hashpower and is priced on **mNAV**, not hashprice. | BTC price & spot-BTC-ETF flows (IBIT) · **mNAV premiums/discounts across the cohort** (MSTR, Metaplanet, Twenty One/XXI, Strive/ASST, MARA-treasury) · convert/preferred issuance conditions & convert-arb appetite · S&P 500 / index-inclusion decisions · fair-value accounting (ASU 2023-08) & CAMT developments · copycat entrant/exit cadence (cohort saturation) |
| `ai-optics` | Datacom interconnect — optical transceivers and components, **and the copper interconnect that competes with them at short reach** (AECs, retimers, SerDes). Widened 2026-08-22 when CRDO was added: copper and optics are one competitive system, not two — an AEC and an AOC bid for the same 2–7 m link, so a slug covering only the optical half would miss the substitute | Hyperscaler capex · NVIDIA architecture shifts (CPO, external laser source, OCP standardization) · LightCounting / Cignal AI vendor rankings · EML and laser supply · China export policy · **copper-reach economics per SerDes generation** — the metres passive DAC / ACC / AEC each reach at 400G, 800G and 224G-per-lane, since every doubling converts passive links into retimed ones and shortens the AEC band · **rack topology decisions that remove links entirely** (NVIDIA MGX cable-free PCB midplanes, NVLink/NVLink Fusion partner lists) — these delete interconnect sockets without any optics involved, and are distinct from the CPO/LPO threat · **AEC and retimer qualification wins at hyperscalers** across Credo, Astera Labs, Marvell, Broadcom and the licensed cable primes (Amphenol, TE Connectivity, Molex) · **LPO vs LRO DSP-attach content** at 800G vs 1.6T |
